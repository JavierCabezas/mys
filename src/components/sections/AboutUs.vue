...
<script>
    export default {
        data () {
            return {
                signature_img_src: "../../src/assets/img/signature.png",
                about_us_img_src: "../../src/assets/img/bg-pattern/about-us.png"
            }
        }
    }
</script>